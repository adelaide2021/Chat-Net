...
public interface Transaction {
   ...
   */
  void prepare(Node nodeInfo, JoinAndLeaveMessageType type);
   ...
   * @param nodeInfo the node who requested the join or leave
   */
  void commit(Node nodeInfo, JoinAndLeaveMessageType type);
   ...
   * @param nodeInfo the node who requested the join or leave
   */
  void drop(Node nodeInfo, JoinAndLeaveMessageType type);
